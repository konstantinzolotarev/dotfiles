;;; my-one-theme.el --- inspired by Atom One Dark -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup my-one-theme nil
...
(def-doom-theme my-one
  ...
  ((elscreen-tab-other-screen-face :background "#353a42" :foreground "#1e2022")
   ...
   ;; elixir-mode
   (elixir-atom-face (&light :foreground blue)
